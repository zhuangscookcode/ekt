...
class Me5Controller extends Controller {
    ...
    public function index()
    {
        ...
        return Redirect::to('j/me5/'.$page_day.'/edit');
    ...
    */
    public function edit($info)
    {
        ...
        return view('j.me5.edit', compact('member_list','Ymd_niki','id1','division1','name1','division_list','id'));
